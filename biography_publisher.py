...
# ============================================================================
# CELEBRATION BALLOONS FUNCTION (FIXED TIMING)
# ============================================================================
...
# ============================================================================
# PDF CLASS with Custom Cover Support (FIXED UNICODE)
# ============================================================================
class PDF(FPDF):
    ...
    def footer(self):
        self.set_y(-15)
        self.set_font('Arial', 'I', 8)
        # Remove special characters that cause Unicode errors
    ...
    def add_cover_page(self, book_title, author_name, cover_type="simple", custom_cover=None):
        ...
        # Safe versions of text
        safe_title = self.safe_text(book_title)
        safe_author = self.safe_text(author_name)
        
        if cover_type == "custom" and custom_cover:
            self.add_custom_cover(custom_cover, safe_title, safe_author)
        else:
            self.add_simple_cover(safe_title, safe_author)
    ...
    def add_custom_cover(self, custom_cover, book_title, author_name):
        ...
        if custom_cover.get('cover_image') and os.path.exists(custom_cover['cover_image']):
            try:
                ...
                # Add text
                title = self.safe_text(custom_cover.get('title', book_title))
                subtitle = self.safe_text(custom_cover.get('subtitle', ''))
                author = self.safe_text(custom_cover.get('author', author_name))
            ...
            # No image, use colors
            bg_color = custom_cover.get('background_color', '#667eea')
            bg_color = bg_color.lstrip('#')
            rgb = tuple(int(bg_color[i:i+2], 16) for i in (0, 2, 4))
            self.set_fill_color(rgb[0], rgb[1], rgb[2])
            self.rect(0, 0, 210, 297, 'F')
            
            title_color = custom_cover.get('title_color', '#FFFFFF')
    ...
    def set_fill_opacity(self, opacity):
        ...
        self._out(f'{alpha} Tr')

# ============================================================================
# PDF GENERATION (FIXED UNICODE)
# ============================================================================
    ...
    if include_toc and stories:
        ...
        for i, story in enumerate(stories, 1):
            ...
            if session_id != current_session:
                ...
                toc_entries.append(("session", session_title))
                current_session = session_id
            question = pdf.safe_text(story.get('question', f'Story {i}'))
            toc_entries.append(("story", i, question))
...
# ============================================================================
# DOCX GENERATION (FIXED CUSTOM COVER)
# ============================================================================
def generate_docx(book_title, author_name, stories, format_style, include_toc=True, include_dates=False, cover_type="simple", custom_cover=None):
    ...
    # Title page
    if cover_type == "custom" and custom_cover:
        # Use custom cover title and author if available
        title_text = custom_cover.get('title', book_title)
        author_text = custom_cover.get('author', author_name)
    ...
    author = doc.add_paragraph(f'by {author_text}')
...
# ============================================================================
# HTML GENERATION (FIXED CUSTOM COVER)
# ============================================================================
def generate_html(book_title, author_name, stories, format_style, include_toc=True, include_dates=False, cover_type="simple", custom_cover=None):
    ...
    if cover_type == "custom" and custom_cover:
        ...
        title_color = custom_cover.get('title_color', '#FFFFFF')
        title_text = custom_cover.get('title', book_title)
        subtitle_text = custom_cover.get('subtitle', '')
        author_text = custom_cover.get('author', author_name)
        ...
        if custom_cover.get('cover_image') and os.path.exists(custom_cover['cover_image']):
            ...
            .book-header h1, .book-header .author, .book-header .subtitle {{
                position: relative;
                z-index: 1;
            }}
            """
...
<body>
    <div class="book-header">
        ...
        <div class="author">by {author_text}</div>
...
def main():
    ...
    if st.session_state.stories_data:
        ...
        st.markdown("""
        ### Features:
        - 🎨 **Custom Cover Support** - Use your designed cover from the main app
