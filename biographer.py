...
# HEART OF YOUR STORY SECTION (Moved after question box)
st.markdown("---")
st.markdown("""
<div style="background-color: #1E3A8A; padding: 20px; border-radius: 10px; margin: 20px 0;">
    <h3 style="color: white; margin: 0;">❤️ The Heart of Your Story</h3>
</div>
<div style="background-color: #EFF6FF; padding: 20px; border-radius: 10px; margin: 10px 0 30px 0;">
    <p style="color: #1E3A8A; font-size: 1.1rem; line-height: 1.6; margin: 0;">
        Your answers to these questions help me support you properly throughout the process and make sure the finished book is exactly right for you and your readers.<br><br>
        The more open and detailed you are here, the easier it is for your real voice and personality to come through on every page. Think of this as a conversation between you and the person who will read your story one day — and I'm here alongside you, listening, capturing what matters, and helping shape it into something lasting.<br><br>
        There's no rush. You can return and add to this whenever new thoughts or memories surface. This is where your story truly begins.
    </p>
</div>
...
# THE BIOGRAPHER'S QUESTIONS SECTION (Moved after Heart)
st.markdown("""
<div style="background-color: #1E3A8A; padding: 20px; border-radius: 10px; margin: 20px 0;">
    <h3 style="color: white; margin: 0;">The Biographer's Questions</h3>
</div>
<div style="background-color: #EFF6FF; padding: 20px; border-radius: 10px; margin: 10px 0 30px 0;">
    <p style="color: #1E3A8A; font-size: 1.1rem; margin: 0;">
        These questions ensure we capture the full richness of your life story.
    </p>
</div>
""", unsafe_allow_html=True)
